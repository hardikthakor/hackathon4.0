...
public class xmpp_chat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AJabberId = bundle.getString("AJabberId");
        jabberId=bundle.getString("jabberId");
        ...
        mChatView.setOnClickSendButtonListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                testChat = chatManagerSend.createChat(jabberId , new ChatMessageListener() {
    ...
    public class MyLoginTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            config = XMPPTCPConnectionConfiguration.builder()
                    .setUsernameAndPassword(AJabberId, "12345")
