...
public class LoadImageTask extends AsyncTask<String, Void, Bitmap>  {
    ...
    public LoadImageTask(Listener listener, String s, int size, String title, String url, String rating, String lat, String lon, String userId, String timestamp, String type, String deviceId,String issueDate,String pincode,String location, String priority,String phothoUrl,String emailId,String JabberId,String jabberId,String tokenId,String proposedDate,String timlineStatus,String description) {
