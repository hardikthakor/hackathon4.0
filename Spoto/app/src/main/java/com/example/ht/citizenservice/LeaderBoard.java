...
public class LeaderBoard extends AppCompatActivity implements LeaderBoardLoadImageTask.Listener{
    ...
    public void callLB () {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                ...
                if (result == null) {
                    tv.setText(R.string.leaderboardnull);
                    dialog.cancel();
                }
                else if (result.equals("")) {
                    tv.setText(R.string.leaderboardinternet);
                    dialog.cancel();
                }
                else if (result.equals("{\"flag\": \"null\"}")) {
                    tv.setText(R.string.leaderboardnodata);
                    dialog.cancel();
                }
                else {
                    JSONArray jsonArray;
